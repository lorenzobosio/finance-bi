...
- [x] 02-01-PLAN.md — Foundation: de-DE format helpers (formatEUR/formatPct) + period/comparability pure helpers + the 6 Wave-0 test scaffolds (BI-04, BI-05)
...
- [x] 02-03-PLAN.md — Calendar-joined SQL marts (P&L/sublet-net/budget-vs-actual/breakdown/%-of-revenue/balance-trend) + per-object RLS + balances UNIQUE + [BLOCKING] live migration (BI-01, BI-02, BI-03, BI-04, BI-07, CAT-06)

**Wave 4** *(blocked on Wave 3)*

- [x] 02-04-PLAN.md — App shell (nav + shared ?period selector + freshness banner) + Home 4 headline KPIs (BI-05, BI-04, BI-01)

**Wave 5** *(blocked on Wave 4)*

- [x] 02-05-PLAN.md — Gastos breakdown + %-of-revenue, Cost Centers budget-vs-actual + Sublocação P&L + waterfall, Config budgets write path (BI-03, BI-02, BI-01, BI-06, BI-04, CAT-06)
