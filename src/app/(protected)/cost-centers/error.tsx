...
// Cost Centers route error boundary (DSN-06d / D3-14) — Next requires `error.tsx` to be a
// Client Component (it receives the `reset` callback that re-renders the segment). Shown when
// the budget-vs-actual / Sublet / household P&L mart reads throw, instead of a blank page.
//
