...
// Adventures bucket route error boundary (DSN-06d) — Next requires error.tsx to be a Client Component
// (it receives the `reset` callback). Shown when the household / investimento / v_bucket_spend reads
// throw, instead of a blank page. Copy reassures: the couple's PROGRESS is never at risk — only this
// view failed to load.
    ...
    <div className="flex flex-1 items-center justify-center py-12">
      ...
      >
        <p className="font-semibold text-card-foreground">
          We couldn&apos;t load your Adventures bucket just now.
        </p>
