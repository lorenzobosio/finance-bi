...
// /health route error boundary (DSN-06d) — Next requires error.tsx to be a Client Component (it
// receives the `reset` callback). Shown when the household / KPI / P&L / budget reads throw, instead
// of a blank page. Non-shame copy: the couple's numbers are safe — only this view failed to load.
